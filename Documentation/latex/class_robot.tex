...
e\+Stop is run when the controller is disconnected do\+Thing runs continously when the controller is connected setup runs once when the microcontroller is turned on \mbox{\Hypertarget{class_robot_a28c6c49c9a12c8767e118e0e8a4165cf}\label{class_robot_a28c6c49c9a12c8767e118e0e8a4165cf}} 
\index{Robot@{Robot}!led@{led}}
\index{led@{led}!Robot@{Robot}}
...
Pointer to an \mbox{\hyperlink{class_l_e_d}{L\+ED}} no code rus from it mearly because it is here. 

Pointer to an \mbox{\hyperlink{class_l_e_d}{L\+ED}} no code rus from it mearly because it is here Stores an pointer to an \mbox{\hyperlink{class_l_e_d}{L\+ED}} class so that all peipherals that acces the \mbox{\hyperlink{class_l_e_d}{L\+ED}} (ie the Tackle Sensor) access the same \mbox{\hyperlink{class_l_e_d}{L\+ED}} \mbox{\Hypertarget{class_robot_a8db438771a3e7dc9d2cf5dd2e1d25f74}\label{class_robot_a8db438771a3e7dc9d2cf5dd2e1d25f74}} 
