 ...
 * Replace every instance of AirCannon in both files with the name of your peripheral.
 *
...
class AirCannon: public Peripheral {
private:
    uint8_t AirCannonLaunchPin;
	ButtonEnum launchButton;
public:
